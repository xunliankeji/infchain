...
#if defined(NDEBUG)
# error "Infchain cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Infchain Signed Message:\n";
    ...
    const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, unsigned int flags)
{
    ...
    // fMiner is true when called from the internal infchain miner
