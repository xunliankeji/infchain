...
{
    resize(970, 550); 
    setWindowTitle(tr("Infchain") + " - " + tr("Wallet"));
    qApp->setStyleSheet("QMainWindow { background-image: url(:images/bkg);border:none;font-family:'Open Sans,sans-serif'; } #frame { } QToolBar QLabel { padding-top: 0px;padding-bottom: 0px;spacing: 10px;color:rgb(255,255,255);} QToolBar QLabel:item { padding-top: 0px;padding-bottom: 0px;spacing: 10px;color:rgb(255,255,255);} #spacer { background:rgb(66,138,176);border:none; } #toolbar2 { border:none;width:0px;hight:0px;padding-top:0px;padding-bottom:0px; background: rgb(32,111,150); } #toolbar { border:1px; height:100%;padding-top:20px; background: rgb(66,138,176); text-align: left; color:rgb(255,255,255);min-width:150px;max-width:150px;} QToolBar QToolButton:hover {background-color:qlineargradient(x1: 0, y1: 0, x2: 2, y2: 2,stop: 0 rgb(66,138,176), stop: 1 rgb(32,111,150),stop: 2 rgb(32,111,150));}"
#ifdef Q_OS_MAC
"QToolBar QToolButton { font-family:sans-serif;font-size:13px;padding-left:20px;padding-right:45px;padding-top:5px;padding-bottom:5px; width:100%; color: rgb(255,255,255); text-align: left; background-color: rgb(66,138,176);  }"
#else
"QToolBar QToolButton { font-family:sans-serif;font-size:13px;padding-left:20px;padding-right:150px;padding-top:5px;padding-bottom:5px; width:100%; color: rgb(255,255,255); text-align: left; background-color: rgb(66,138,176);  }"
#endif
"#labelMiningIcon { padding-left:5px;font-family:sans-serif;width:100%;font-size:10px;text-align:center;color:rgb(255,255,255); } QMenu { background: rgb(66,138,176); color:rgb(255,255,255); padding-bottom:10px; } QMenu::item { color:rgb(255,255,255); background-color: transparent; } QMenu::item:selected { background-color:qlineargradient(x1: 0, y1: 0, x2: 0.5, y2: 0.5,stop: 0 rgb(66,138,176), stop: 1 rgb(32,111,150)); } QMenuBar { background: rgb(66,138,176); color:rgb(255,255,255); } QMenuBar::item { font-size:12px;padding-bottom:6px;padding-top:6px;padding-left:15px;padding-right:15px;color:rgb(255,255,255); background-color: transparent; } QMenuBar::item:selected { background-color:qlineargradient(x1: 0, y1: 0, x2: 0.5, y2: 0.5,stop: 0 rgb(32,111,150), stop: 1 rgb(66,138,176)); }");
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Infchain address"));
    ...
    exchangeAction = new QAction(QIcon(":/icons/exchange"), tr("&Exchange (Coming Soon...)"), this);
    exchangeAction->setToolTip(tr("Exchange function"));
...
/*    connect(exchangeAction, SIGNAL(triggered()), this, SLOT(gotoExchangePage()));*/
    ...
    aboutAction = new QAction(tr("&About Infchain"), this);
    aboutAction->setToolTip(tr("Show information about Infchain"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Infchain"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Infchain client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Infchain client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Infchain network", "", count));
}
...
/*void BitcoinGUI::gotoExchangePage()
{
    ...
    centralStackedWidget->addWidget(exchangePage);
    centralStackedWidget->setCurrentWidget(exchangePage);
    exchangePage->setModel(this->clientModel);
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Infchain address or malformed URI parameters."));
    }
